...
c_ManeuverShuntP(bus,t)$(ord(t) ge 2)..
    V_shunt(bus,t) - V_shunt(bus,t-1) =l= V_Ushunt(bus,t);
c_ManeuverShuntN(bus,t)$(ord(t) ge 2)..
...
c_ManeuverTapP(i,j,c,t)$(transformer(i,j,c))..
    V_ratio(i,j,c,t) - V_ratio(i,j,c,t-1) =l= 999999;
c_ManeuverTapN(i,j,c,t)$(transformer(i,j,c))..
    V_ratio(i,j,c,t-1) - V_ratio(i,j,c,t) =l= 999999;
