...
c_ManeuverTapP(i,j,c,t)$(transformer(i,j,c))..
    V_ratio(i,j,c,t) - V_ratio(i,j,c,t-1) =l= 2 * V_Uratio(i,j,c,t);
c_ManeuverTapN(i,j,c,t)$(transformer(i,j,c))..
    V_ratio(i,j,c,t-1) - V_ratio(i,j,c,t) =l= 2 * V_Uratio(i,j,c,t);
