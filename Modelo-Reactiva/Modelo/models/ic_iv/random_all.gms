...
*$if %condensed% == 'no' V_LineIr.l(i,j,c)$(branchstatus(i,j,c) or branchstatus(j,i,c)) = uniform(-rateA(i,j,c),rateA(i,j,c));
*$if %condensed% == 'no' V_LineIq.l(i,j,c)$(branchstatus(i,j,c) or branchstatus(j,i,c)) = uniform(-rateA(i,j,c),rateA(i,j,c));
