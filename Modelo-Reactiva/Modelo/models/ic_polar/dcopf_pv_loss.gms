...
$call gams "%filepath%dcopf.gms" --Plim=%Plim% --allon=%allon% --limits=%limits% --case="%case%" --obj=%obj% --lineloss=1.055 gdx=dctemp.gdx lo=3 --timeperiod=%timeperiod% --verbose=%verbose%
