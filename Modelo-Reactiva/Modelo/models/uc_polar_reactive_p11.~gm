...
variable
    V_ManeuverTap(i,j,c,t)   "Maneuver Tap Postive ABS"
    V_UManeuverTap(i,j,c,t)
...
equations
    ...
    c_ManeuverTap(i,j,c,t)    "Maneuver Tap  ABS"
...
c_LinePij(i,j,c,t)$(branchstatus(i,j,c,t))..
         V_LineP(i,j,c,t) =e=
            (g(i,j,c) * sqr(V_V(i,t)) / ((0.005*V_ratio(i,j,c,t) + 0.895)*(0.005*V_ratio(i,j,c,t)+ 0.895)))
            - (V_V(i,t) * V_V(j,t) / (0.005*V_ratio(i,j,c,t)+ 0.895)) *
...
c_LineQij(i,j,c,t)$(branchstatus(i,j,c,t))..
         V_LineQ(i,j,c,t) =e=
            - (sqr(V_V(i,t)) * (b(i,j,c) + bc(i,j,c)/2) / ((0.005*V_ratio(i,j,c,t)+ 0.895)*(0.005*V_ratio(i,j,c,t)+ 0.895)))
            - (V_V(i,t) * V_V(j,t) / (0.005*V_ratio(i,j,c,t)+ 0.895)) *
...
**    138*(V_ratio(i,j,c,t) - V_ratio(i,j,c,t-1)) =l= V_Uratio(i,j,c,t) + 0.5;
**c_ManeuverTapN(i,j,c,t)$(transformer(i,j,c) and (ord(t) ge 2))..
**    138*(V_ratio(i,j,c,t-1) - V_ratio(i,j,c,t)) =l= V_Uratio(i,j,c,t) + 0.5
**;
...
* ABS value Tap ratio transformer maneuver
*c_ManeuverTapP(i,j,c,t)$(transformer(i,j,c) and (ord(t) ge 2))..
*    V_ManeuverTap(i,j,c,t) =e= 138*(V_ratio(i,j,c,t) - V_ratio(i,j,c,t-1));

*V_UManeuverTap(i,j,c,t)$(V_ManeuverTap(i,j,c,t) > 0.5) = 1;

*if (V_ManeuverTap(i,j,c,t) > 0.5,
*    V_UManeuverTap(i,j,c,t) = 1;

*else
*    V_UManeuverTap(i,j,c,t) = 0;
...
* ABS value Tap ratio transformer maneuver
c_ManeuverTapP(i,j,c,t)$(transformer(i,j,c) and (ord(t) ge 2))..
    V_ratioP(i,j,c,t) =l= V_Uratio(i,j,c,t)*(23 - V_ratio(i,j,c,t-1));
c_ManeuverTapN(i,j,c,t)$(transformer(i,j,c) and (ord(t) ge 2))..
    V_ratioN(i,j,c,t) =l= V_Uratio(i,j,c,t)*(V_ratio(i,j,c,t-1) - 1);
c_ManeuverTap(i,j,c,t)$(transformer(i,j,c) and (ord(t) ge 2))..
    V_ratio(i,j,c,t) =e=  V_ratio(i,j,c,t-1) + V_ratioP(i,j,c,t) - V_ratioN(i,j,c,t);

*V_ManeuverTap(i,j,c,t)$(transformer(i,j,c) and (ord(t) ge 2)) =e= (V_ratio(i,j,c,t) - V_ratio(i,j,c,t-1));


*a $ (c_ManeuverTap(i,j,c,t) > 0.3) = 1;
...
**            c_ManeuverShuntP, c_ManeuverShuntN,
            c_ManeuverTapP,
            c_ManeuverTapN,
            c_ManeuverTap,
*            c_BinShunt,
...
V_ratio.up(i,j,c,t)$(transformer(i,j,c)) = 23;

* Ratio tap transformer limits
*V_ratioN.lo(i,j,c,t)$(transformer(i,j,c)) = 0.9;
*V_ratioN.up(i,j,c,t)$(transformer(i,j,c)) = 1.1;

* Ratio tap transformer limits
*V_ratioP.lo(i,j,c,t)$(transformer(i,j,c)) = 0.9;
*V_ratioP.up(i,j,c,t)$(transformer(i,j,c)) = 1.1;
...
V_ratio.l(i,j,c,t) = (200*ratio(i,j,c) - 179);


V_ratioP.l(i,j,c,t) = V_Uratio.l(i,j,c,t)*(23- V_ratio.l(i,j,c,t));
V_ratioN.l(i,j,c,t) = V_Uratio.l(i,j,c,t)*(V_ratio.l(i,j,c,t)-1);

* Derived variables
V_LineP.l(i,j,c,t)$branchstatus(i,j,c,t) =  (g(i,j,c) * sqr(V_V.l(i,t)) / ((0.005*V_ratio.l(i,j,c,t)+ 0.895)*(0.005*V_ratio.l(i,j,c,t)+ 0.895)))
            - (V_V.l(i,t) * V_V.l(j,t) / (0.005*V_ratio.l(i,j,c,t)+ 0.895)) *
 ...
 V_LineQ.l(i,j,c,t)$branchstatus(i,j,c,t) = - (sqr(V_V.l(i,t)) * (b(i,j,c) + bc(i,j,c)/2) / ((0.005*V_ratio.l(i,j,c,t)+ 0.895)*(0.005*V_ratio.l(i,j,c,t)+ 0.895)))
            - (V_V.l(i,t) * V_V.l(j,t) / (0.005*V_ratio.l(i,j,c,t)+ 0.895)) *
