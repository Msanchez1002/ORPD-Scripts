...
c_BalanceQ(i,t)$(type(i) ne 4)..
          ...
          - (sqr(V_V(i,t)) * (Bs(i)/100) * V_shunt(i,t))$(atBusSwitchedBs(i))
...
* Bus shunt solution
    shuntB(i,t)$(atBusSwitchedBs(i))  = V_shunt.l(i,t);
...
execute_unload '%filepath%temp_solution.gdx', t, Pg, Qg, Vm, Va, shuntB, total_cost, LMP, LineSP, status, Tap;
