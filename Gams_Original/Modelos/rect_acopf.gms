$title "AC optimal power flow model, rectangular power-voltage formulation"
*_______________________________________________________________________________
* Filename: rect_acopf.gms
* Description: AC optimal power flow model, rectangular power-voltage formulation
*
* Usage: gams rect_acopf.gms --case=/path/case.gdx
*
* Options:
...
$ifthen %ic% == 1 $batinclude '%filepath%ic_rect%sep%random_all.gms' condensed verbose
$elseif %ic% == 2 $batinclude '%filepath%ic_rect%sep%flat.gms' condensed verbose
$elseif %ic% == 3 $batinclude '%filepath%ic_rect%sep%random_v.gms' condensed verbose
$elseif %ic% == 4 $batinclude '%filepath%ic_rect%sep%dcopf_pv.gms' linelimits condensed verbose allon obj timeperiod
$elseif %ic% == 5 $batinclude '%filepath%ic_rect%sep%dcopf_v.gms' linelimits condensed verbose allon obj timeperiod
$elseif %ic% == 6 $batinclude '%filepath%ic_rect%sep%decoupled.gms' linelimits allon condensed allon obj verbose
$elseif %ic% == 7 $batinclude '%filepath%ic_rect%sep%dcopf_pv_loss ' linelimits allon condensed verbose
$elseif %ic% == 8 $batinclude '%filepath%ic_rect%sep%matpower.gms' linelimits condensed verbose
$elseif %ic% == 9 $batinclude '%filepath%ic_rect%sep%given.gms' condensed verbose
$else $batinclude '%filepath%ic_rect%sep%default.gms' condensed verbose
$endif
...
lines_at_limit(i,j,c)$(branchstatus(i,j,c) or branchstatus(j,i,c)) = yes$
     (sqr(rateA(i,j,c)) - sqr(V_LineP.L(i,j,c)) - sqr(V_LineQ.L(i,j,c)) le 1e-4);
