...
$call gams "%filepath%ic_polar%sep%ic_xls2gdx.gms" --in="%filepath%ic_polar%sep%sol_%casename%.xlsx"

parameters ic_bus, ic_gen;

$GDXIN %filepath%ic_polar%sep%sol_%casename%.gdx
$LOAD ic_bus, ic_gen
$GDXIN
...
execute 'rm "%filepath%ic_polar%sep%sol_%casename%.gdx"' ;
