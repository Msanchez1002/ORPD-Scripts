...
*--- Define output file
*--- --in=D:\Documentos\Maestría\Tesis\Gams_Original\Testcases_gdx\case57.gdx
file
    fx1
...
* Calculate new information
    businfo(bus,'Pd',t) = 1*origPd(bus) * (hourlyload(t,season,daytype)/100);
    businfo(bus,'Qd',t) = 1*origQd(bus) * (hourlyload(t,season,daytype)/100);
    businfo(bus,'Vm',t) = 1;
    businfo(bus,'Va',t) = 0;
